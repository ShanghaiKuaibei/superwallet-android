define(['app', 'services/WalletService'], function (app) {
    'use strict';
    app.register.controller('SrmimaCtrl1', ['$scope', '$rootScope', '$window', function ($scope, $rootScope, $window) {
        ...
        //         document.getElementById('title').innerHTML = '再次绘制手势密码';
        ...
        //     this.pswObj = {};
        //     document.getElementById('title').innerHTML = '请绘制手势密码';
        //     document.getElementById('content').style.display = 'block';
        //     this.reset();
        // }
        // $window.H5lock.prototype.initDom = function () {
        //     var wrap = document.createElement('div');
        //     var str = '<p id="title" class="title" style="color: #E8F8F9;text-shadow: 1px 1px 5px #37BFD2;margin-top: 30%; font-size: 20px;filter:alpha(opacity=20); font-family: "Microsoft YaHei !important";>请绘制手势密码</p><p id="content" style="color: #E8F8F9;text-shadow: 1px 1px 5px #37BFD2; font-size: 14px; line-height: 30px;">请牢记你的手势密码，忘记后无法进入</p>' + '<canvas id="canvas" width="300px" height="300px"; style="display: inline-block; margin:0px auto;"></canvas>' + '<a id="updatePassword" style=" position: relative;top: 5px;color:#E8F8F9;font-size: 14px;display:none;">重置密码</a>';
